...
public class CountTest extends BaseTestCase {
    private static final boolean EXPLAIN = true; // 类似 sql explain

    /***
     * GET /goods/goods/_search { "query": { "multi_match": { "query": "代价伤痕2dd0dwxx012",
     * "fields": [ "content", "title" ], "minimum_should_match": "49%", "type":
     * "best_fields", "operator": "OR" } }, "explain": true, "size": 20 }
     */
    @Test
    public void count() {
...
//         request.setTokenizer("index_ansj");
        ...
        System.out.println(response.getHits().getTotalHits() + ",maxscore: "
